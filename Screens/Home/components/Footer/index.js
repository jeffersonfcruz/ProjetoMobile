  ...
  return (
    <View style={footer.container}>
      <View style={footer.options}>
        ...
        >
          <Image
            source={require("../../../../assets/shopping_icon.png")}
            style={footer.imgfooter}
          />
      ...
      <View style={footer.options}>
        ...
        >
          <Image
            source={require("../../../../assets/search_icon_f.png")}
            style={footer.imgfooter}
          />
      ...
      <View style={footer.options}>
        ...
        >
          <Image
            source={require("../../../../assets/dress_icon.png")}
            style={footer.imgfooter}
          />
      ...
      <View style={footer.options}>
        ...
        >
          <Image
            source={require("../../../../assets/price_promotion.png")}
            style={footer.imgfooter}
          />
